...
//whenever there is a script being accessed, this fromBuffer() gets called
//TODO high: read https://en.bitcoin.it/wiki/Script and understand this file
Script.fromBuffer = function(buffer) {
  //too many logs, comment out for now
  //console.debug(`YCM TRACKER === bitcore-lib/lib/script/script.js fromBuffer()`);
